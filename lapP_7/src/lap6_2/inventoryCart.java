...
public class inventoryCart {
  ...
  //atibute f
	...
	//method
		...
		public int get_volume(int index_volume) {
			return proInCart[index_volume].get_volume();
		}
		
		public int get_weigth(int index_weigth) {
			return proInCart[index_weigth].get_Weigth();
		}
}
